...
const setChartData = () => {
    ...
    const hombresTotal = props.registrosMecatronica.reduce(
        (total, item) => total + item.hombres1 + item.hombres2,
        0
    );
    const mujeresTotal = props.registrosMecatronica.reduce(
    ...
    <AppLayout title="Mecatronica">
        ...
        <div class="max-w-[99.9%] m-auto p-2">
            <Toolbar class="mb-4">
                <template #start>
                    <Button
                        v-if="is('Mecatronica-registrar || Administrador || SecretarioAcademico')"
                        label="Registrar"
                        icon="pi pi-plus"
                        severity="success"
                        class="!mr-3"
                    ...
                    />
                    <Button
                        v-if="is('Mecatronica-eliminar || Administrador || SecretarioAcademico')"
                        label="Eliminar"
                        icon="pi pi-trash"
                        severity="danger"
                ...
                <div class="contendorTabla">
                    ...
                    >
                        ...
                        <Column
                            ...
                            v-if="is('Mecatronica-editar || Administrador || SecretarioAcademico')"
                        >
                        </Column>
