...
const setChartData = () => {
    ...
    const hombresTotal = props.registrosSistemas.reduce(
        (total, item) => total + item.hombres1 + item.hombres2,
        0
    );
    const mujeresTotal = props.registrosSistemas.reduce(
    ...
    <AppLayout title="Sistemas Computacionales">
        ...
        <div class="max-w-[99.9%] m-auto p-2">
            <Toolbar class="mb-4">
                <template #start>
                    <Button
                        v-if="is('Sistemas-registrar || Administrador || SecretarioAcademico')"
                        label="Registrar"
                        icon="pi pi-plus"
                        severity="success"
                        class="!mr-3"
                    ...
                    />
                    <Button
                        v-if="is('Sistemas-eliminar || Administrador || SecretarioAcademico')"
                        label="Eliminar"
                        icon="pi pi-trash"
                        severity="danger"
                ...
                <div class="contendorTabla">
                    ...
                    >
                        ...
                        <Column
                            ...
                            v-if="is('Sistemas-editar || Administrador || SecretarioAcademico')"
                        >
                        </Column>
