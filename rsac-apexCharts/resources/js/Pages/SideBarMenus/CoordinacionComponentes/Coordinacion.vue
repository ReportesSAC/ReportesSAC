...
const setChartData = () => {
    ...
    const hombresTotal = props.registrosCoordinacion.reduce(
        (total, item) => total + item.hombres1 + item.hombres2,
        0
    );
    const mujeresTotal = props.registrosCoordinacion.reduce(
    ...
    <AppLayout title="Coordinación Académica">
        ...
        <div class="max-w-[99.9%] m-auto p-2">
            <Toolbar class="mb-4">
                <template #start>
                    <Button
                        v-if="is('Coordinacion-registrar || Administrador || SecretarioAcademico')"
                        label="Registrar"
                        icon="pi pi-plus"
                        severity="success"
                        class="!mr-3"
                    ...
                    />
                    <Button
                        v-if="is('Coordinacion-eliminar || Administrador || SecretarioAcademico')"
                        label="Eliminar"
                        icon="pi pi-trash"
                        severity="danger"
            ...
            <div class="contenedorGraficaTabla">
                <div
                    ...
                    class="w-full flex items-center flex-col gap-0.2 mt-15 mb-20"
                >
                    <div class="w-full">
                        <Chart
                            type="bar"
                    ...
                    <div
                        id="graficas"
                        class="flex justify-center items-center w-full mb-20"
                    >
                ...
                <div class="contendorTabla">
                    ...
                    >
                        ...
                        <Column
                            ...
                            v-if="is('Coordinacion-editar || Administrador || SecretarioAcademico')"
                        >
                        </Column>
