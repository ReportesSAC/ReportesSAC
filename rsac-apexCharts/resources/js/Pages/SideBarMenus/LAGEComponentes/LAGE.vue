...
const setChartData = () => {
    ...
    const hombresTotal = props.registrosLage.reduce(
        (total, item) => total + item.hombres1 + item.hombres2,
        0
    );
    const mujeresTotal = props.registrosLage.reduce(
    ...
    <AppLayout title="LAGE">
        ...
        <div class="max-w-[99.9%] m-auto p-2">
            <Toolbar class="mb-4">
                <template #start>
                    <Button
                        v-if="is('LAGE-registrar || Administrador || SecretarioAcademico')"
                        label="Registrar"
                        icon="pi pi-plus"
                        severity="success"
                        class="!mr-3"
                    ...
                    />
                    <Button
                        v-if="is('LAGE-eliminar || Administrador || SecretarioAcademico')"
                        label="Eliminar"
                        icon="pi pi-trash"
                        severity="danger"
                ...
                <div class="contendorTabla">
                    ...
                    >
                        ...
                        <Column
                            ...
                            v-if="is('LAGE-editar || Administrador || SecretarioAcademico')"
                        >
                        </Column>
